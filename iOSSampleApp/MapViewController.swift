...
class MapViewController: UIViewController, CLLocationManagerDelegate {
    ...
    override func viewDidLoad() {
        ...
        _ = wemap.configure(config: wemapsdk_config(
            token: "",//"GUHTU6TYAWWQHUSR5Z5JZNMXX", 22418
            mapId: 22211 ,   // 19158,  normal -> 23225 , roland -> 20034, AR -> 22211
            offlineOptions: OfflineOptions(enable: false, tiles: "http", blacklist: [1,4,3])
...
extension MapViewController: wemapsdkViewDelegate {
...
//        wemap.openPinpoint(WemapPinpointId: 31604315)
        ...
        self.wemap.setPinpoints(WemapPinpoints: [pinpoint])
        // NAVIGATE TO PINPOINT
        self.wemap.navigateToPinpoint(WemapPinpointId: 1)
        
         //let location = WemapLocation(longitude: 4, latitude: 50)
         //self.wemap.navigateToPinpoint(WemapPinpointId:1, location: location, heading: 50)
...
//        }
    ...
    @objc func onPermissionsDenied(_ wemapController: wemapsdk, deniedPermissions: [String]) {
        print("permissions denied: \(deniedPermissions)")
    }
}
